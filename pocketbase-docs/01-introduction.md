...
- [Download v0.39.7 for Linux x64](https://github.com/pocketbase/pocketbase/releases/download/v0.39.7/pocketbase_0.39.7_linux_amd64.zip) (~12MB zip)
- [Download v0.39.7 for Windows x64](https://github.com/pocketbase/pocketbase/releases/download/v0.39.7/pocketbase_0.39.7_windows_amd64.zip) (~12MB zip)
- [Download v0.39.7 for macOS x64](https://github.com/pocketbase/pocketbase/releases/download/v0.39.7/pocketbase_0.39.7_darwin_amd64.zip) (~12MB zip)

**ARM64:**

- [Download v0.39.7 for Linux ARM64](https://github.com/pocketbase/pocketbase/releases/download/v0.39.7/pocketbase_0.39.7_linux_arm64.zip) (~11MB zip)
- [Download v0.39.7 for Windows ARM64](https://github.com/pocketbase/pocketbase/releases/download/v0.39.7/pocketbase_0.39.7_windows_arm64.zip) (~11MB zip)
- [Download v0.39.7 for macOS ARM64](https://github.com/pocketbase/pocketbase/releases/download/v0.39.7/pocketbase_0.39.7_darwin_arm64.zip) (~11MB zip)
...
**Navigation:** [Next: How to use PocketBase →](02-how-to-use.md)

---

> **Source:** [pocketbase.io/docs](https://pocketbase.io/docs/)
