...
The access and filter controls for your data are usually done through the collection [API rules and filters](04-api-rules-and-filters.md).

For the cases when you need more specialized handling (sending emails, intercepting the default actions, creating new routes, etc.) you can [extend PocketBase with Go or JavaScript](08-use-as-framework.md).
...
- [Use PocketBase as Go/JS framework](08-use-as-framework.md) to create new routes or intercept existing.
...
**Navigation:** [← Introduction](01-introduction.md) | [Collections →](03-collections.md)

---

> **Source:** [pocketbase.io/docs/how-to-use](https://pocketbase.io/docs/how-to-use)
